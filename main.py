...
class Dots_and_Boxes:
    def __init__(self):
        ...
        self.player1_score_label = Label(self.window, text="Player 1: 0", font="cmr 15 bold", fg=player1_color)
        self.player1_score_label.pack()
        self.player2_score_label = Label(self.window, text="Player 2: 0", font="cmr 15 bold", fg=player2_color)
        self.player2_score_label.pack()
        
        # Create reset button
        self.reset_button = Button(self.window, text="Reset", command=self.reset_game, font="cmr 15 bold")
    ...
    def update_scores(self):
        ...
        self.player1_score_label.config(text=f"Player 1: {player1_score}")
        self.player2_score_label.config(text=f"Player 2: {player2_score}")
